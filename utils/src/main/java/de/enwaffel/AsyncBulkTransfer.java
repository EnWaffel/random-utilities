...
public class AsyncBulkTransfer {
     ...
     */
    private static final short VENDOR_ID = 92;

    /**
     * The vendor ID of the Samsung Galaxy Nexus.
     */
    private static final short PRODUCT_ID = 5426;
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Open test device
        final DeviceHandle handle = LibUsb.openDeviceWithVidPid(context,
        ...
        read(handle, 100, new TransferCallback() {
            @Override
            public void processTransfer(Transfer transfer) {
                System.out.println(new String(transfer.buffer().array()));
            }
        });
